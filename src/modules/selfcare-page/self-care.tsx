        ...
        <div className="font-archivo">
            ...
            <div className="lg:flex lg:flex-row ">
                ...
                <section className="">
                    ...
                    <div className="mx-5 px-8 pt-3 pb-8 mb-4 drop-shadow-xl bg-pure-white md:mx-16">
                    ...
                    {/* I Want To.. Dropdown */}
                    <div className='mx-5 px-8 pt-3 pb-8 mb-4 drop-shadow-xl bg-pure-white lg:h-80 md:mx-16'>
                        <p>I want to...</p>
                        <SelfCareDropdown />
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div className='mx-5 px-8 pt-3 pb-8 mb-4 drop-shadow-xl bg-pure-white md:mx-16'>
                        ...
                        <p>since you started! You're awesome! <a href='/goals' className='text-sea-green-blue'>Go to Goals.</a></p>
                    </div>
                    ...
                    <div className='mx-5 px-8 pt-3 pb-8 mb-4 drop-shadow-xl bg-pure-white md:mx-16'>
                        ...
                        <p>Consistency is key! <a href='/habits' className='text-sea-green-blue'>Go to Habits.</a></p>
                    </div>
                    {/* Today I feel Div */}
                    <div className='flex flex-col mx-5 px-8 pt-3 pb-8 mb-4 drop-shadow-xl bg-pure-white md:mx-16'>
                        <p>I want to...</p>
                        <FeelingsDropdown />
