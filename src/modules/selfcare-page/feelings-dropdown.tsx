...
const FeelingsDropdown = () => {
    return ( 
        <div>
            ...
            <div>
                <Menu.Button className="inline-flex  gap-x-1.5 rounded-md bg-white pl-3 w-96 py-2 pl-3 text-sm font-semibold shadow-sm ring-1 ring-inset ring-black hover:bg-gray-50">Select an emotion
